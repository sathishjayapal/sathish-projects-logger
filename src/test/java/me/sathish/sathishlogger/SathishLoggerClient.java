...
/**
 * Simple HTTP client for SathishLogger service
 * Drop this class into any Java project to send logs to SathishLogger
 */
...
logger.error("Request failed", correlationId, exception);

// Async logging (non-blocking)
logger.infoAsync("Background task completed");
*/
